...
public class WxpayLogger {
    ...
    public static void setNeedEnableLogger(boolean needEnableLogger) {
        WxpayLogger.needEnableLogger = needEnableLogger;
    }
     ...
     * 发生特别错误时记录完整错误现场
     */
    public static void logErrorScene(Map<String, Object> rt, WxpayResponse tRsp,
                                     String appSecret) {
        if (!needEnableLogger) {
            return;
        }
        ...
        sb.append("^_^");
        sb.append("urlParams:");
        appendLog((WxpayHashMap) rt.get("urlParams"), sb);
        sb.append("^_^");
        sb.append("Body:");
    ...
    private static void appendLog(WxpayHashMap map, StringBuilder sb) {
        boolean first = true;
