    ...
    public static String doPost(String url, Map<String, String> params,
        ...
        try {
            try {
                ...
                WxpayLogger.logCommError(e, url, map.get("app_key"), map.get("method"), params);
                throw e;
            }
...
//        conn.setRequestProperty("User-Agent", "aop-sdk-java");
    ...
    //for weixin pay
    public static String doHttpPost2Wx(String url, String postBody, String charset, int connectTimeout, int readTimeout) throws Exception{
